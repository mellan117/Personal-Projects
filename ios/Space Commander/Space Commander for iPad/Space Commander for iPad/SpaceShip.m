...
/*+(CCScene *) spaceShipScene {
    CCScene *spaceShipScene = [CCScene node];
    GameHUD *hud = [GameHUD node];
    [spaceShipScene addChild:hud];
    
    SpaceShip *layer = [[[SpaceShip alloc] initWithHUD:hud] autorelease];
    [spaceShipScene addChild:layer];
